"""
Django settings for covidNews project.
...
WSGI_APPLICATION = 'covidNews.wsgi.application'
...
CRONJOBS = [('* * * * *','searchNews.cron.callApi', '>>/tmp/scheduled_job.log 2>&1')]
